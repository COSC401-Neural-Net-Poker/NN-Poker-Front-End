...
const Login = ({reg}) => {
  ...
  return (
    <div className="bg-gray-300 w-1/2 h-1/2 flex justify-center flex-col items-center text-[#4B4B4B]">
      ...
      <form className="mt-2 flex flex-col items-center w-1/2" onSubmit={(e) => handleLogin(e)}>
        ...
        <button className="mb-4 rounded-md w-full py-1 font-semibold bg-[#4B4B4B] text-white" type="submit">Login</button>
      </form>
      <button onClick={() => handleGoogle()} className="bg-[#fef9f3] mb-5 w-1/2 duration-150 hover:bg-[#FF8200] hover:text-white flex justify-center items-center py-1 px-2 rounded-xl">
        <Icon className="mr-3 text-[30px]" icon="flat-color-icons:google" />Sign in with google
      </button>
